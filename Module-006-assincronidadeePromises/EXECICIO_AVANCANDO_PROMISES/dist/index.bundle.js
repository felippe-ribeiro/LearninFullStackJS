...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ _default)\n/* harmony export */ });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar _default = /*#__PURE__*/function () {\n  function _default(spaceship) {\n    _classCallCheck(this, _default);\n\n    this.spaceship = spaceship;\n  }\n\n  _createClass(_default, [{\n    key: \"turnOn\",\n    value: function turnOn() {\n      var _this = this;\n\n      var currentChargeChecking = this.checkCurrentCharge();\n      var shieldChecking = this.testShield();\n      Promise.all([currentChargeChecking, shieldChecking]).then(function (results) {\n        return _this.shieldNormalizer(results[1]);\n      }).then(function (newShield) {\n        _this.spaceship.shield = newShield;\n        console.log(\"(\".concat(_this.spaceship.name, \") Partida autorizada: Escudo (\").concat(_this.spaceship.shield, \") - Carga(\").concat(_this.spaceship.currentCharge, \"GJ)\"));\n      })[\"catch\"](function (error) {\n        console.log(\"(\".concat(_this.spaceship.name, \") Partida n\\xE3o autorizada: \").concat(error));\n      });\n    }\n  }, {\n    key: \"checkCurrentCharge\",\n    value: function checkCurrentCharge() {\n      var _this2 = this;\n\n      return new Promise(function (resolve, reject) {\n        var currentCharge = _this2.spaceship.currentPercentCharge();\n\n        if (currentCharge >= 30) {\n          resolve(currentCharge);\n        } else {\n          reject(\"Carga em apenas \".concat(currentCharge, \"GJ\"));\n        }\n      });\n    }\n  }, {\n    key: \"testShield\",\n    value: function testShield() {\n      var _this3 = this;\n\n      return new Promise(function (resolve, reject) {\n        var doubledShield = _this3.spaceship.shield * 2;\n\n        if (doubledShield >= 100) {\n          resolve(doubledShield);\n        } else {\n          reject(\"Escudo em sobrecarga\");\n        }\n      });\n    }\n  }, {\n    key: \"shieldNormalizer\",\n    value: function shieldNormalizer(shield) {\n      return new Promise(function (resolve, reject) {\n        var normalizedShield = shield * 0.7;\n\n        if (normalizedShield > 120) {\n          reject(\"Escudo em supercarga\");\n        } else {\n          resolve(normalizedShield);\n        }\n      });\n    }\n  }]);\n\n  return _default;\n}();\n\n\n\n//# sourceURL=webpack://set_interval_set_timeout/./src/spaceship_engine.js?");
